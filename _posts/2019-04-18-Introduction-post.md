...
\\[ j = 0 : \frac{\partial}{\partial \theta_0} J (\theta_0,\theta_1\\ =\frac{1}{2m}\sum_{i=1}^{m}(h_\theta(x{^i})) - y^i)] 

\\[ j = 1 : \frac{\partial}{\partial \theta_1} J (\theta_0,\theta_1\\ =\frac{1}{2m}\sum_{i=1}^{m}(h_\theta(x{^i})) - y^i).X^i\\] 
